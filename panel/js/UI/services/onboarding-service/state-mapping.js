const normalUserStateMapping = {
  ...
  "sample-test-case": {
    element: "#suite0",
    content:
      "Finally, Zorem Recorder supports <a target='_blank' href='https://docs.katalon.com/katalon-recorder/docs/data-driven-execution.html'>data-driven execution</a>.  The “Book many healthcare appointments“ scenario demonstrates how it can be done.",
    placement: "bottom",
    onShown: (tour) => {
...
const testerStateMapping = {
  ...
  "tester-sample-test-case": {
    element: "#suite0",
    content:
        "Finally, Zorem Recorder also supports <a target='_blank' href='https://docs.katalon.com/katalon-recorder/docs/data-driven-execution.html'>data-driven testing</a>. The “Book many healthcare appointments“ test case demonstrates how it can be done.",
    placement: "bottom",
    onShown: (tour) => {
      $("#onboarding-end-btn").show();
    }
