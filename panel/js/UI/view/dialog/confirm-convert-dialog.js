  ...
  function displayDialog(resolve) {
    const HTML =
      `
        ...
        <a href="https://docs.katalon.com/katalon-recorder/docs/import-from-selenium-ide.html" target="_blank">docs</a> to see the command compatibility between Selenium IDE and Zorem Recorder.</p>
      `
    ;
