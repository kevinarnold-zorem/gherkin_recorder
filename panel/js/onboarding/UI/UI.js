import shuffle from "../service/shuffle.js";
...
function displayWelcomeDialogForExistingUsers() {
    function displayDialog(resolve) {
        ...
        const welcomeHTML = getCommonStyledHtmlString(
            ...
            <p>This product tours guide you through the indispensible features of Zorem Recorder.</p>
           
            <p>What are you already using Zorem Recorder for?</p>
...
function displayWelcomeDialog() {
    function displayDialog(resolve) {
        ...
        const welcomeHTML = getCommonStyledHtmlString(`
            <form>
            <div style='text-align:center'>
                <h1>Welcome to Zorem Recorder</h1>
            </div>
...
function displayFinishDialog() {
    ...
    <div style="margin=10px">
        <div style="width: 50%; float:right;">
            <a href="https://docs.katalon.com/x/cRtO?utm_source=chrome%20recorder%20pop-up" target="_blank">
                ...
                <div style="text-align: center">
                    <h3>User Manual</h3>
                    <p>Guides to utilize Zorem Recorder for automation effectively.</p>
                </div>
            </a>
        </div>
    ...
    let finishDialog = $('<div id="onboarding-finish-dialog"></div>')
        ...
        .dialog({
            ...
            modal: true,
            buttons: {
                "Start using Zorem Recorder": {
                    text: "Start using Zorem Recorder",
                    id: "finish",
                    click: (_) => {
